/// @file projective.vert
/// @brief Physics test playground vertex shader with procedural geometry.
#version 450
...
//   Boxes    [0..1079]    30 axis-aligned boxes x 36 verts
//   Ramps    [1080..1139] 2 ramps x 30 verts (wedge shapes)
//   DiagWall [1140..1175] 1 diagonal wall x 36 verts
//   Floor    [1176..1181] 1 floor quad x 6 verts
//
// Total: 1182 vertices.

// Box geometry
// 30 AABBs, procedurally generated from (min, max) pairs.
...
// Generate a vertex position for box `boxIdx` at local vertex `lv` in [0..35].
...
// Ramp geometry
// 2 wedge ramps, 30 verts each (5 faces x 6).
//
...
const int RAMP_VERTS   = 60;               // 2 ramps x 30

// Gentle ramp (15 deg): x in [-214,-86], z in [950,1250], h=80
// Steep ramp  (40 deg): x in [86,214],   z in [1000,1200], h=168
...
// Diagonal wall (45 deg)
// 36 verts (6 faces x 6).
//
