...
constexpr HudSvgName kHudSvgNames[] = {
    ...
    {HudIcon::DashAbilityIcon, "DashIcon.svg"},
    {HudIcon::Grapple, "grapple.svg"},
    {HudIcon::GrappleAbilityIcon, "GrappleIcon.svg"},
    {HudIcon::Gravity, "gravity.svg"},
    {HudIcon::GravityAbilityIcon, "GravityFlipIcon.svg"},
    {HudIcon::LevitateAbilityIcon, "levitate.svg"},
    ...
    {HudIcon::WallhackAbilityIcon, "player_arrow.svg"},
    {HudIcon::RecallAbilityIcon, "RecallIcon.svg"},
