...
void AudioManifest::buildDefault()
{
    ...
    clips_ = {
        ...
        makeClip("railgun_fire", SfxId::RailGunFire, "Weapons", 1.0f, 2.5f, 0.20f, true, false, 4),
        makeClip("rifle_reload", SfxId::RifleReload, "Weapons", 0.9f, 1.4f, 0.0f, false, false, 1),
        makeClip("rocket_reload", SfxId::RocketReload, "Weapons", 0.9f, 1.4f, 0.0f, false, false, 1),
        makeClip("railgun_reload", SfxId::RailGunReload, "Weapons", 0.9f, 1.4f, 0.0f, false, false, 1),
        makeClip("energy_reload", SfxId::EnergyReload, "Weapons", 0.9f, 1.4f, 0.0f, false, false, 1),
        makeClip("shotgun_reload", SfxId::ShotgunReload, "Weapons", 0.9f, 1.4f, 0.0f, false, false, 1),
        makeClip("railgun_charge_start", SfxId::RailGunCharge, "Weapons", 0.9f, 1.7f, 0.0f, false, false, 1),
        makeClip("energy_start", SfxId::EnergyGunFire, "Weapons", 1.0f, 1.8f, 0.0f, true, false, 4),
        makeClip("shotgun_fire", SfxId::ShotgunFire, "Weapons", 1.0f, 2.1f, 0.20f, true, false, 4),
        makeClip("grenade_throw", SfxId::GrenadeThrow, "Weapons", 0.9f, 1.2f, 0.12f, true, false, 8),
        makeClip("beam_loop", SfxId::EnergyBeamLoop, "Weapons", 1.0f, 1.8f, 0.0f, true, true, 4),
        ...
        makeClip("powerup_damage_pickup", SfxId::DamagePowerupPickup, "Player", 0.85f, 2.2f, 0.15f, true, false, 4),
        makeClip("powerup_overshield_pickup", SfxId::OvershieldPowerupPickup, "Player", 0.85f, 2.2f, 0.15f, true, false, 4),
    ...
    events_ = {
        ...
        makePlayEvent("weapon.rifle.reload", "node.rifle_reload"),
        makePlayEvent("weapon.rocket.reload", "node.rocket_reload"),
        makePlayEvent("weapon.railgun.reload", "node.railgun_reload"),
        makePlayEvent("weapon.energy.reload", "node.energy_reload"),
        makePlayEvent("weapon.shotgun.reload", "node.shotgun_reload"),
        makePlayEvent("weapon.railgun.charge_start", "node.railgun_charge_start"),
        makePlayEvent("weapon.energy.start", "node.energy_start"),
        makePlayEvent("weapon.shotgun.fire", "node.shotgun_fire"),
        ...
        makePlayEvent("explosion.rocket", "node.explosion_rocket"),
        makePlayEvent("explosion.molotov", "node.explosion_molotov"),
        makePlayEvent("explosion.he", "node.explosion_he"),
        ...
        makePlayEvent("powerup.pickup", "node.powerup_pickup"),
        makePlayEvent("powerup.damage_pickup", "node.powerup_damage_pickup"),
        makePlayEvent("powerup.overshield_pickup", "node.powerup_overshield_pickup"),
