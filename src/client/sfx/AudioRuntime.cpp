...
void AudioManifest::buildDefault()
{
    ...
    clips_ = {
        ...
        makeClip("energy_fire", SfxId::EnergyGunFire, "Weapons", 0.9f, 1.8f, 0.0f, true, false, 8),
        makeClip("shotgun_fire", SfxId::ShotgunFire, "Weapons", 1.0f, 2.1f, 0.20f, true, false, 6),
        makeClip("grenade_throw", SfxId::GrenadeThrow, "Weapons", 0.9f, 1.2f, 0.12f, true, false, 8),
        makeClip("beam_loop", SfxId::EnergyBeamLoop, "Weapons", 0.72f, 1.8f, 0.0f, true, true, 4),
